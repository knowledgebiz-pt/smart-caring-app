export default {
  translation: {
    ...
    forgot_password_subtext:
      "Enter your e-mail or phone number in order to create a new password",
    ...
    enter_code_subtext:
      "Enter the code you received in your e-mail or phone number",
    ...
    new_password_subtext:
      "Your new password should be unique so you don't forget it :)",
    ...
    password_format_error:
      "Password must contain at least 8 characters, at least one upper case and one lower case letter, at least one number and at least one special character.",
    ...
    create_account_terms_begin:
      "By clicking Let's go!, Sign up with Google, or Sign up with Facebook, you agree to our ",
    ...
    // FEATURES SCREEN
    features_one:
      "Get ready to connect with people, share your daily experiences, and chat in groups or privately.",
    features_two:
      "Use the calendar to organize your day-to-day, and keep track of your appointments, medication, and events.",
    features_three:
      "We provide you with a page with several tools, such as apps and websites, to help you deal with dementia.",
    ...
    navbar_schedule: "My Schedule",
    navbar_journal: "Journal",

    // HOMEPAGE SCREEN
    homepage_hello: "Hello",
    homepage_post_placeholder: "What's on your mind?",
    homepage_like: "Like",
    homepage_comment: "Comment",
    homepage_no_comments: "No comments",
    homepage_toast_error_get_posts: "Error getting feed posts.",
    homepage_toast_error_login: "Error: failed to login.",
    homepage_post_url_title: "URL Link",
    homepage_post_url_message:
      'Please insert the whole URL to the webpage you wish to link to in your post, including either "https://" or "http://" :',
    ...
    report_message: "Your report has been sent successfully.",
    homepage_menu_terms_use: "Terms of Use",
    homepage_menu_language: "Switch to Portuguese",
    homepage_menu_logout: "Logout",
    home_delete_account_message:
      "Are you sure you want to delete your account?",
    ocult: "Ocult",
    report: "Report",
    homepage_menu_logout_delete: "Delete Account",
    ...
    homepage_comment_get_error:
      "An error has occurred when trying to fetch the comments from a post.",
    homepage_comment_see: "See ",
    homepage_comment_lowercase: "comment",
    homepage_comments: "comments",
    homepage_error_like: "An error has occurred when trying to like a post.",
    homepage_error_unlike:
      "An error has occurred when trying to remove a like from a post.",
    homepage_error_favorite:
      "An error has occurred when trying to favorite a post.",
    homepage_error_unfavorite:
      "An error has occurred when trying to unfavorite a post.",
    ...
    post_input_toast_created_post: "You have created a new post!",
    post_input_toast_error_post: "Error creating post.",
    post_input_toast_created_comment: "Comment has been created.",
    post_input_toast_error_comment: "Error commenting on post.",
    post_input_toast_no_url: "No URL has been set.",
    post_input_toast_url_https: 'URL missing "http://" or "https://"',
    post_input_toast_url_valid: "Valid URL has been set!",
    post_input_toast_url_invalid: "URL has been set, but is invalid.",

    // CHAT SCREEN
    chat_messages_unread: "messages unread",
    create_chat: "start chating",
    group_chat: "Group",
    ...
    journal_toast_entries_get_error: "Error getting journal entries.",
    journal_toast_entry_characters:
      "Entry content must contain at least 50 characters.",
    journal_toast_created_entry: "Entry created successfully.",
    journal_toast_entry_deleted: "Entry deleted successfully.",
    journal_begin_message:
      "To begin using the journal, please create a new entry by pressing the green button below on the right.",
    journal_entry_add_category: "Add a new category",
    journal_create_entry: "Create entry",
    journal_entry_category_placeholder: "Select a category",
    journal_create_category: "Create category",
    journal_category_name: "Category name",
    journal_category_color: "Select a color",
    ...
    schedule_event_date_time_end: "Select date and time to end",
