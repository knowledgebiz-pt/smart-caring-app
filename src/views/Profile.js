      ...
      .then(token => {
        UserService.getUserDataByIdUserCorrectly(token).then(res => {
          ...
          if (res.data.user_type.toLowerCase() === "caregiver") {
            ...
            res.data.user_type.toLowerCase() === "health professional"
          ) {
  ...
  Appearance.addChangeListener(({ colorScheme }) => {
    ...
    if (Platform.OS === "android")
      NavigationBar.setBackgroundColorAsync(
        colorScheme === "light" ? colors.BaseSlot1 : colors.BaseSlot1
      );
  });
    ...
    >
      ...
      >
        ...
        <ScrollView style={[styleSelected.backgroundPrimary, { flex: 1 }]}>
          ...
          <Text
            style={[
              styleSelected.textBold20DarkBlue,
              { marginTop: 45, textAlign: "center" }
            ]}
          >
            {t("homepage_menu_profile")}
          </Text>
          ...
          >
            ...
            <InputTransparentLabelAbove
              value={name}
              onChangeText={text => setName(text)}
              fontSize={13}
              inputColor={colors.BaseSlot3}
              fullWidth={true}
              hasBorder={true}
            ...
            <View style={{ marginTop: 7, flexDirection: "row" }}>
              <DatePickerTransparentLabelAbove
                viewWidth={"20%"}
                event={() => {
                  setShowPicker(true);
                }}
                ...
                onDateChange={date => {
                  setShowPicker(false);
                  setBirthDate(new Date(date["nativeEvent"]["timestamp"]));
                }}
                date={birthDate}
                placeholder={t("age") + "*"}
              />
              <TogglerTransparentLabelAbove
                initial={gender === "M" ? 0 : 1}
                viewWidth={"80%"}
                onPress={value => {
                  setGender(value);
                }}
                ...
                fullWidth={true}
                label={t("gender") + "*"}
                optionOneLabel={t("male")}
                optionOneValue={"M"}
                optionTwoLabel={t("female")}
                optionTwoValue={"F"}
              />
            </View>
            <Text
              style={[
                styleSelected.textRegular13DarkBlue,
                { marginLeft: 30, marginTop: 7, marginBottom: 6 }
              ]}
            >
              {t("create_account_role")}
            </Text>
            <ButtonOutlineSuccessIcon
              styleButton={{
                backgroundColor:
                  indexSelectedButton === "1" ? colors.BaseSlot4 : "transparent"
              }}
              styleText={{
                color:
              ...
              title={t("caregiver")}
            />
            <ButtonOutlinePrimaryIcon
              styleButton={{
                backgroundColor:
                  indexSelectedButton === "2" ? colors.BaseSlot2 : "transparent"
              }}
              styleText={{
                color:
              ...
              onPress={() => {
                setIndexSelectedButton("2");
                setRole("Health Professional");
              }}
              fullWidth={true}
              title={t("healthPro")}
            />
            <ButtonOutlineDarkBlueIcon
              styleButton={{
                backgroundColor:
                  indexSelectedButton === "3" ? "#030849" : "transparent"
              }}
              styleText={{
                color:
                  indexSelectedButton === "3" ? colors.BaseSlot1 : "#030849"
              }}
              styleImage={{
                tintColor:
                  indexSelectedButton === "3" ? colors.BaseSlot1 : "#030849"
            ...
            />
            <View
              style={{ width: "40%", alignSelf: "flex-end", marginRight: 110 }}
            >
              <TogglerTransparentLabelLeft
                ...
                hasBorder={false}
                fullWidth={true}
                label={t("create_account_share")}
                optionOneLabel={t("yes")}
                optionOneValue={true}
                optionTwoLabel={t("no")}
            ...
            <TogglerTransparentLabelAbove
              ...
              fullWidth={true}
              label={t("language")}
              optionOneLabel={t("portuguese")}
              optionOneValue={"pt"}
              optionTwoLabel={t("english")}
              optionTwoValue={"en"}
            />
            <PhoneInputTransparentLabelAbove
              ...
              hasBorder={true}
              borderColor={colors.BaseSlot5}
              placeholder={t("create_account_phone")}
            />
          </View>
          <View
            style={{
