...
export default function HeaderLogoAndProfileImage({
  img,
  onPressImage,
  user,
  refreshItems
  ...
  const options = [
    ...
    {
      id: 2,
      name: t("homepage_menu_privacy_policy"),
      value: "privacypolicy",
      icon: "shield-account",
    ...
    // {
    //   id: 3,
    //   name: t("homepage_menu_terms_use"),
    //   value: "termsofuse",
    //   icon: "file-check",
    //   iconType: "MaterialCommunityIcons"
    // },
    ...
    {
      id: 6,
      name: t("homepage_menu_logout_delete"),
      value: "delete",
      icon: "delete",
      iconType: "MaterialCommunityIcons"
    }
  ...
  const optionPressed = option => {
    ...
    if (option.value === "logout") {
      ...
      Alert.alert(
        t("homepage_menu_logout_delete"),
        t("home_delete_account_message"),
        [
          {
            text: t("cancel"),
          ...
          },
          {
            text: t("delete"),
            onPress: () => {
              console.log("ID " + userInfo._id.$oid);
              UserService.deleteUser(userInfo._id.$oid)
                .then(res => {
  ...
  return (
    <View style={{ flexDirection: "row" }}>
      <Image
        ...
        style={styleSelected.logoLeftSide}
        resizeMode="contain"
      />
      <View
        style={{
      ...
      >
        <TouchableOpacity
          ...
          style={[styleSelected.avatarRightSide]}
        >
          <Image
                ...
                >
                  <Text
                    style={[
                      ...
                      list.iconType === "FontAwesome" && { marginLeft: 0 }
                    ]}
                  >
                    {list.name}
                  </Text>
