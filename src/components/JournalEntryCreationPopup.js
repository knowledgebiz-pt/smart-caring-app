...
export default function JournalEntryCreationPopup({
  ...
  const [newCategory, setNewCategory] = useState({
    ...
    value: null,
    color: null,
    icon: () => <FontAwesome name="circle" color={"black"} />
  });
  ...
  const [items, setItems] = useState([
    {
      label: t("journal_entry_add_category"),
      value: "newCat",
      icon: () => <FontAwesome name="circle" color={"gray"} />
    }
  ...
  const [colorItems, setColorItems] = useState([
    {
      label: "Red",
      value: "red",
      icon: () => <FontAwesome name="circle" color={"red"} />
    },
    {
      label: "Green",
      value: "green",
      icon: () => <FontAwesome name="circle" color={"green"} />
    },
    {
      label: "Blue",
      value: "blue",
      icon: () => <FontAwesome name="circle" color={"blue"} />
    },
    {
      label: "Red",
      value: "red1",
  ...
  const checkValue = val => {
    ...
    if (val == "newCat") {
      ...
      let chosenCategoryIndex = items.findIndex(x => {
        return x.value === val;
      });
      ...
      setEntry({
        title: entry.title,
        category: items[chosenCategoryIndex].label,
        categoryColor: items[chosenCategoryIndex].color,
        date: entry.date,
  ...
  return (
    <KeyboardAvoidingView style={{ paddingTop: 10 }}>
      ...
      <View style={styleSelected.modalCenteredView}>
        ...
        >
          <Pressable
            style={styleSelected.modalCenteredView}
            onPress={event =>
          ...
          >
            ...
            >
              ...
              <View style={{ justifyContent: "center", alignItems: "center" }}>
                <Text
                  style={{ fontSize: 18, fontWeight: 600, color: "#1CA3FC" }}
                >
                  {t("journal_create_entry")}
                </Text>
              </View>
              <View style={{ flex: 1, flexDirection: "row" }}>
                ...
                <View style={{ flex: 0.9 }}>
                  ...
                  >
                    <Text
                      style={[
                        ...
                        { marginLeft: 10, marginBottom: 5, fontWeight: 600 }
                      ]}
                    >
                      {t("title")}
                    </Text>
                    <TextInput
                      style={[
                        styleSelected.buttonSizeFullWidth,
                        {
                          borderWidth: 0.5,
                  ...
                  <View style={{ flex: 0.3, marginTop: 20, zIndex: 898887 }}>
                    <Text
                      style={[
                        styleSelected.textRegular13DarkBlue,
                        { marginLeft: 10, marginBottom: 5, fontWeight: 600 }
        ...
        >
          ...
          >
            <Text style={{ fontSize: 18, fontWeight: 600, color: "#1CA3FC" }}>
              {t("journal_create_category")}
            </Text>
          </View>
          <View
            style={{
          ...
          >
            <View style={{ flex: 0.3 }}>
              <InputTransparentLabelAbove
                ...
                fullWidth={true}
                inputMode="text"
                placeholder={t("journal_category_name")}
              />
            </View>
            <View style={{ flex: 0.5, zIndex: 9999 }}>
              <Text
                style={[
                  styleSelected.textRegular13DarkBlue,
              ...
              <DropDownPicker
                ...
                onChangeValue={val => {
                  setNewCategory({
                    ...
                    color: val,
                    icon: () => <FontAwesome name="circle" color={val} />
                  });
                }}
                searchable={false}
                open={openColorItems}
            ...
            <View
              style={{ flex: 0.2, alignItems: "center", paddingBottom: 15 }}
            >
              <ButtonPrimary
                event={() => {
