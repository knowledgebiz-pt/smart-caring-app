...
export default function ButtonOutlineDarkBlueIcon({ title, styleButton, styleText, styleImage, onPress, fullWidth=false, event }) {
    ...
    return (
        <TouchableOpacity
            onPress={onPress}
            style={[sizeStyleSelected, {borderWidth: 0.5, borderColor: '#030849', marginBottom: 20, }, styleButton]}>
                <View style={{flexDirection:"row", justifyContent: "space-between"}}>
            <Text style={[styleSelected.buttonOutlineDarkBlueIconText, {marginLeft: 20}, styleText]}>
                {title}
            </Text><Image style={[{width: 35, height: 20, marginRight: 20}, styleImage]} source={require("../../assets/images/Patient.png")}/>
